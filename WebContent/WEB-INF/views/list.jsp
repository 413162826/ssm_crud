...
<body>
	...
	<div class="container">
		...
		<!-- 显示分页-->
	 	<div class="row">
			<!-- 分页信息 -->
			<div class="col-md-6">当前${pageInfo.getPageNum()}页,总${pageInfo.getPages() }页,总${pageInfo.getTotal() }条记录</div>
			<!-- 分页条信息 -->
			<div class="col-md-6">
				...
				<c:if test="${pageInfo.hasPreviousPage }">
						...
						<li><a href="${path }/emps?pn=${pageInfo.getPageNum()-1}" aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
						</a></li>
				</c:if>
					...
					<c:if test="${pageInfo.hasNextPage }">
						<li><a href="${path }/emps?pn=${pageInfo.pageNum+1}" aria-label="Next"> <span aria-hidden="true">&raquo;</span>
						</a></li>
					</c:if>
